...
const SidebarRight = ({selectedUser}) => {
  return selectedUser && (
    <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? 'mx-md-hidden' : ''}`}>
      <div className='pt-16 flex-col gap-2 text-xs font-light mx-auto flex items-center'>
      ...
      <div className='px-5 text-xs'>
        <p className=''>Media</p>
        <div className='max-h-[200px] overflow-y-scroll grid grid-cols-2 gap-4 opacity-80 mt-2'>
